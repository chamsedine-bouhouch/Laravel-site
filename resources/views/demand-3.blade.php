...
<head>
    ...
    <title>Sign Up Form</title>
      ...
      <!-- Font Icon -->
    <link rel="stylesheet" href="multiForm/fonts/material-icon/css/material-design-iconic-font.min.css">

    <!-- Main css -->
    <link rel="stylesheet" href="multiForm/css/style.css">
</head>
<body>
    ...
    <!-- JS -->
    <script src="multiForm/vendor/jquery/jquery.min.js"></script>
    <script src="multiForm/vendor/jquery-validation/dist/jquery.validate.min.js"></script>
    <script src="multiForm/vendor/jquery-validation/dist/additional-methods.min.js"></script>
    <script src="multiForm/vendor/jquery-steps/jquery.steps.min.js"></script>
    <script src="multiForm/vendor/minimalist-picker/dobpicker.js"></script>
    <script src="multiForm/vendor/jquery.pwstrength/jquery.pwstrength.js"></script>
    <script src="multiForm/multiForm/js/main.js"></script>
</body>
</html>