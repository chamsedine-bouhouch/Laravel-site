              ...
              <div class="d-flex">
                <div class="dropdown mr-1 ml-md-auto">
                  ...
                  <div class="dropdown-menu" aria-labelledby="dropdownMenuOffset">
                    <a class="dropdown-item" href="index.blade.php?categorie=électricité">Electricité</a>
        ...
        <div class="col-md-3 order-1 mb-5 mb-md-0">
            ...
            <div class="mb-4">
              ...
              <label for="s_sm" class="d-flex">
                <input type="checkbox" id="dep" class="mr-2 mt-1"> <span class="text-black">Dépannage ({{count($services)}})</span>
              </label>
              <label for="s_md" class="d-flex">
                <input type="checkbox" id="inst" class="mr-2 mt-1"> <span class="text-black">Installation (1,282)</span>
              </label>
          ...
          <div class="border p-4 rounded mb-4">
            ...
            <ul class="list-unstyled mb-0">
              <li class="mb-1"><a href="services/electricité" class="d-flex"><span>Electricité</span> <span class="text-black ml-auto">(2,220)</span></a></li>
